...
public class ProducaoController {
    ...
    @GetMapping("/obterTodasAsProducoes/{idDocente}/{anoIni}/{anoFin}")
    public ResponseEntity<?> obterTodasAsProducoes(@PathVariable(value = "idDocente", required = true) Integer idDocente,
    ...
    @PutMapping("/atualizarEstatisticasProducao")
    public ResponseEntity<?> atualizaEstatisticasProducao(@RequestParam(value = "idPrograma", required = true) Integer idPrograma,
